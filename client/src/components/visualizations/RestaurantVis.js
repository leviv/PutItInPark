...
const API_ENDPOINT =
  "https://api.foodcravings.net/api/restaurant?page%5Bsize%5D=50&page%5Bnumber%5D=1";
...
class RestaurantVis extends React.Component {
  ...
  plotRestaurants() {
    ...
    let y = d3
      .scaleLinear()
      .domain([0, d3.max(this.state.cuisines, (d) => d.count)])
      .nice()
    ...
    svg.append("g").call(xAxis).style("font-size", "25px");

    svg.append("g").call(yAxis).style("font-size", "25px");
  }

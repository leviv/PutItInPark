  ...
  plotRecipes() {
    ...
    const pack = (data) =>
      d3
        .pack()
        .size([960 - 2, 600 - 2])
        .padding(3)(d3.hierarchy({ children: data }).sum((d) => d.calories));
    ...
    leaf
      ...
      .on("mouseover", function (d, i) {
        ...
        div
          .html(
            displayName(d.data.name) + "<br/>" + formatNumber(d.data.calories)
          )
    ...
    leaf
      .append("text")
      .text(function (d) {
        return displayName(truncate(d.data.name));
      })
      .style("fill", "#204653")
